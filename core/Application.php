...
class testProject {
	...
	/**
	 * Login information used for the database
	 * DBHOST = the database host
	 * DBDATABASE = the name of the database to use
	 * DBUSER = the name of the database user(login)
	 * DBPASSWORD = the password to use for the login
	 * 
	 */
	const DBHOST = 'www.agdragon.net';
	const DBDATABASE = 'test_project';
	const DBUSER = 'testproject';
	const DBPASSWORD = 'Zenap74wAFrA';
	...
	public static function DBH() {
		if (!self::$DBH)
			...
			self::$DBH = new PDO("mysql:host=" . self::DBHOST . ";dbname=" . self::DBDATABASE, self::DBUSER, self::DBPASSWORD);
